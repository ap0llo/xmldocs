...
/// <summary>
/// Tests for <see cref="MethodMemberElement"/>
/// </summary>
public class MethodMemberElementTest : CommonMemberElementTests
{
    protected override MemberElement CreateInstanceFromXml(string xml) =>
        MethodMemberElement.FromXml(MemberId.Parse("M:MyNamespace.MyClass.Method"), XmlContentHelper.ParseXmlElement(xml));
