...
/// <summary>
/// Tests for <see cref="BulletedListElement"/>
/// </summary>
public class BulletedListElementTest
{
    [Fact]
    public void Items_must_not_be_null()
    {
        ...
        // ACT 
        var ex = Record.Exception(() => new BulletedListElement(items: null!));
    ...
    {
        // ARRANGE
        var instance1 = new BulletedListElement(Array.Empty<ListItem>());
        var instance2 = new BulletedListElement(Array.Empty<ListItem>());
    ...
    {
        // ARRANGE
        var instance1 = new BulletedListElement(
            new[]
            {
                new SimpleListItem(new TextBlock(new PlainTextElement("item 1")))
            });
        var instance2 = new BulletedListElement(
            new[]
            {
                new SimpleListItem(new TextBlock(new PlainTextElement("item 1")))
            });
    ...
    {
        // ARRANGE
        var sut = new BulletedListElement(Array.Empty<ListItem>());
